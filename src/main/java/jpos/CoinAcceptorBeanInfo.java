...
public class CoinAcceptorBeanInfo extends SimpleBeanInfo
{
	public BeanDescriptor getBeanDescriptor()
	{
		return new BeanDescriptor( CoinAcceptor.class );
	}

	public PropertyDescriptor makeProperty( String paramString ) throws IntrospectionException
	{
		return new PropertyDescriptor( paramString, CoinAcceptor.class );
	}
	...
	public EventSetDescriptor makeEvent( String paramString ) throws IntrospectionException, ClassNotFoundException
	{
		...
		return new EventSetDescriptor( CoinAcceptor.class, paramString, Class.forName( str ), paramString + "Occurred" );
	}
