...
public class POSKeyboardBeanInfo extends SimpleBeanInfo
{
	...
	{
		return new PropertyDescriptor( paramString, POSKeyboard.class );
	}
	...
	public EventSetDescriptor makeEvent( String paramString ) throws IntrospectionException, ClassNotFoundException
	{
		...
		return new EventSetDescriptor( POSKeyboard.class, paramString, Class.forName( str ), paramString + "Occurred" );
	}
