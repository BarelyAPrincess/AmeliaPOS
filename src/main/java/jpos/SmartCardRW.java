...
import jpos.services.SmartCardRWService110;
import jpos.services.SmartCardRWService111;
import jpos.services.SmartCardRWService112;
import jpos.services.SmartCardRWService113;
import jpos.services.SmartCardRWService114;
import jpos.services.SmartCardRWService18;
import jpos.services.SmartCardRWService19;

public class SmartCardRW extends BaseJposControl implements SmartCardRWControl114, JposConst
{
	...
	public void setDataEventEnabled( boolean paramBoolean ) throws JposException
	{
		...
		try
		{
			service18.setDataEventEnabled( paramBoolean );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setInterfaceMode( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service18.setInterfaceMode( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setIsoEmvMode( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service18.setIsoEmvMode( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setPowerNotify( int paramInt ) throws JposException
	{
		...
		try
		{
			service18.setPowerNotify( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setSCSlot( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
	...
	public void beginInsertion( int paramInt ) throws JposException
	{
		...
		try
		{
			service18.beginInsertion( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void beginRemoval( int paramInt ) throws JposException
	{
		...
		try
		{
			service18.beginRemoval( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void readData( int paramInt, int[] paramArrayOfInt, String[] paramArrayOfString ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service18.readData( paramInt, paramArrayOfInt, paramArrayOfString );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void writeData( int paramInt1, int paramInt2, String paramString ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service18.writeData( paramInt1, paramInt2, paramString );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	protected void setDeviceService( BaseService paramBaseService, int paramInt ) throws JposException
	{
		...
		else
		{
			if ( serviceVersion >= 1008000 )
			{
				try
				{
					service18 = ( ( SmartCardRWService18 ) paramBaseService );
				}
				catch ( Exception localException1 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService18 interface", localException1 );
				}
			}
			if ( serviceVersion >= 1009000 )
			{
				try
				{
					service19 = ( ( SmartCardRWService19 ) paramBaseService );
				}
				catch ( Exception localException2 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService19 interface", localException2 );
				}
			}
			if ( serviceVersion >= 1010000 )
			{
				try
				{
					service110 = ( ( SmartCardRWService110 ) paramBaseService );
				}
				catch ( Exception localException3 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService110 interface", localException3 );
				}
			}
			if ( serviceVersion >= 1011000 )
			{
				try
				{
					service111 = ( ( SmartCardRWService111 ) paramBaseService );
				}
				catch ( Exception localException4 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService111 interface", localException4 );
				}
			}
			if ( serviceVersion >= 1012000 )
			{
				try
				{
					service112 = ( ( SmartCardRWService112 ) paramBaseService );
				}
				catch ( Exception localException5 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService112 interface", localException5 );
				}
			}
			if ( serviceVersion >= 1013000 )
			{
				try
				{
					service113 = ( ( SmartCardRWService113 ) paramBaseService );
				}
				catch ( Exception localException6 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService113 interface", localException6 );
				}
			}
			if ( serviceVersion >= 1014000 )
			{
				try
				{
					service114 = ( ( SmartCardRWService114 ) paramBaseService );
				}
				catch ( Exception localException7 )
				{
					throw new JposException( 104, "Service does not fully implement SmartCardRWService114 interface", localException7 );
				}
			}
		}
	}
	...
	protected class SmartCardRWCallbacks implements EventCallbacks
	{
		protected SmartCardRWCallbacks()
		{
		}

		public BaseControl getEventSource()
		{
			return SmartCardRW.this;
		}
