...
public class Belt extends BaseJposControl implements BeltControl114, JposConst
{
	...
	public void setAutoStopBackward( boolean paramBoolean ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.setAutoStopBackward( paramBoolean );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setAutoStopBackwardDelayTime( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.setAutoStopBackwardDelayTime( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setAutoStopForward( boolean paramBoolean ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.setAutoStopForward( paramBoolean );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void setAutoStopForwardDelayTime( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.setAutoStopForwardDelayTime( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void moveBackward( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.moveBackward( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void moveForward( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.moveForward( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	public void resetItemCount( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.resetItemCount( paramInt );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	protected void setDeviceService( BaseService paramBaseService, int paramInt ) throws JposException
	{
		...
		else
		{
			if ( serviceVersion >= 1012000 )
			{
				try
				{
					service112 = ( ( BeltService112 ) paramBaseService );
				}
				catch ( Exception localException1 )
				{
					throw new JposException( 104, "Service does not fully implement BeltService112 interface", localException1 );
				}
			}
			if ( serviceVersion >= 1013000 )
			{
				try
				{
					service113 = ( ( BeltService113 ) paramBaseService );
				}
				catch ( Exception localException2 )
				{
					throw new JposException( 104, "Service does not fully implement BeltService113 interface", localException2 );
				}
			}
			if ( serviceVersion >= 1014000 )
			{
				try
				{
					service114 = ( ( BeltService114 ) paramBaseService );
				}
				catch ( Exception localException3 )
				{
					throw new JposException( 104, "Service does not fully implement BeltService114 interface", localException3 );
				}
			}
		}
	}
	...
	protected class BeltCallbacks implements EventCallbacks
	{
		protected BeltCallbacks()
		{
		}
