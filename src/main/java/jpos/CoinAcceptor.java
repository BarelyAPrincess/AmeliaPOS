	...
	protected void setDeviceService( BaseService paramBaseService, int paramInt ) throws JposException
	{
		...
		else
		{
			if ( serviceVersion >= 1011000 )
			{
				try
				{
					service111 = ( ( CoinAcceptorService111 ) paramBaseService );
				}
				catch ( Exception localException1 )
				{
					throw new JposException( 104, "Service does not fully implement CoinAcceptorService111 interface", localException1 );
				}
			}
			if ( serviceVersion >= 1012000 )
			{
				try
				{
					service112 = ( ( CoinAcceptorService112 ) paramBaseService );
				}
				catch ( Exception localException2 )
				{
					throw new JposException( 104, "Service does not fully implement CoinAcceptorService112 interface", localException2 );
				}
			}
			if ( serviceVersion >= 1013000 )
			{
				try
				{
					service113 = ( ( CoinAcceptorService113 ) paramBaseService );
				}
				catch ( Exception localException3 )
				{
					throw new JposException( 104, "Service does not fully implement CoinAcceptorService113 interface", localException3 );
				}
			}
			if ( serviceVersion >= 1014000 )
			{
				try
				{
					service114 = ( ( CoinAcceptorService114 ) paramBaseService );
				}
				catch ( Exception localException4 )
				{
					throw new JposException( 104, "Service does not fully implement CoinAcceptorService114 interface", localException4 );
				}
			}
		}
	}
