...
public class Lights extends BaseJposControl implements LightsControl114, JposConst
{
	...
	public void switchOff( int paramInt ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
	...
	public void switchOn( int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5 ) throws JposException
	{
		if ( !bOpen )
		{
			throw new JposException( 101, "Control not opened" );
		...
		try
		{
			service112.switchOn( paramInt1, paramInt2, paramInt3, paramInt4, paramInt5 );
		}
		catch ( JposException localJposException )
		{
			throw localJposException;
	...
	protected void setDeviceService( BaseService paramBaseService, int paramInt ) throws JposException
	{
		...
		else
		{
			if ( serviceVersion >= 1012000 )
			{
				try
				{
					service112 = ( ( LightsService112 ) paramBaseService );
				}
				catch ( Exception localException1 )
				{
					throw new JposException( 104, "Service does not fully implement LightsService112 interface", localException1 );
				}
			}
			if ( serviceVersion >= 1013000 )
			{
				try
				{
					service113 = ( ( LightsService113 ) paramBaseService );
				}
				catch ( Exception localException2 )
				{
					throw new JposException( 104, "Service does not fully implement LightsService113 interface", localException2 );
				}
			}
			if ( serviceVersion >= 1014000 )
			{
				try
				{
					service114 = ( ( LightsService114 ) paramBaseService );
				}
				catch ( Exception localException3 )
				{
					throw new JposException( 104, "Service does not fully implement LightsService114 interface", localException3 );
				}
			}
		}
	}
	...
	protected class LightsCallbacks implements EventCallbacks
	{
