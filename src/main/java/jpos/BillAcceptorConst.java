...
public abstract interface BillAcceptorConst
{
	public static final int BACC_STATUS_OK = 0;
	public static final int BACC_STATUS_FULL = 21;
	public static final int BACC_STATUS_NEARFULL = 22;
	public static final int BACC_STATUS_FULLOK = 23;
	public static final int BACC_STATUS_JAM = 31;
	public static final int BACC_STATUS_JAMOK = 32;
