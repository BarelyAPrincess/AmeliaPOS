...
public class CashDrawerBeanInfo extends SimpleBeanInfo
{
	public BeanDescriptor getBeanDescriptor()
	{
		return new BeanDescriptor( CashDrawer.class );
	}

	public PropertyDescriptor makeProperty( String paramString ) throws IntrospectionException
	{
		return new PropertyDescriptor( paramString, CashDrawer.class );
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors()
	{
		try
		{
			PropertyDescriptor[] arrayOfPropertyDescriptor = {makeProperty( "CapStatus" ), makeProperty( "CapPowerReporting" ), makeProperty( "CapStatusMultiDrawerDetect" ), makeProperty( "CapStatisticsReporting" ), makeProperty( "CapUpdateStatistics" ), makeProperty( "CapCompareFirmwareVersion" ), makeProperty( "CapUpdateFirmware" ), makeProperty( "DrawerOpened" ), makeProperty( "PowerNotify" ), makeProperty( "PowerState" )};
	...
	public EventSetDescriptor makeEvent( String paramString ) throws IntrospectionException, ClassNotFoundException
	{
		...
		return new EventSetDescriptor( CashDrawer.class, paramString, Class.forName( str ), paramString + "Occurred" );
	}
